...
if __name__ == "__main__":
  ...
  with open(sys.argv[3], "w") as output:
    output.write(str(allDocsAsNumpyArrays.take(3)))
  ...
  with open(sys.argv[4], "w") as output:
    output.write(str(allDocsAsNumpyArraysTFidf.take(2)))
  ...
  with open(sys.argv[5], "w") as output:
    output.write(str(task2prediction1))
  with open(sys.argv[6], "w") as output:
    output.write(str(task2prediction2))
  with open(sys.argv[7], "w") as output:
    output.write(str(task2prediction3))
  ...
  categorybycount = numdocspercategory.sort('count', ascending=[False])
  with open(sys.argv[10], "w") as output:
    output.write(str(categorybycount.head(10)))
